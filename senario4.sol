...
/**
 * @title PSC (Paradaise Supply Chain) — با مدیریت AccessControl و MultiSig-ready
 * @dev از AccessControl برای مدیریت نقش‌ها استفاده می‌کند.
 *      EXECUTOR_ROLE: مجری توزیع ایردراپ و عرضه‌های سالانه
 *      ADMIN_ROLE: مدیریت نقش‌ها و تنظیمات
 */
contract PSC is ERC20, ReentrancyGuard, AccessControl {
    ...
    // ============================
    // AIRDROP — فقط توسط EXECUTOR_ROLE
    // ============================
