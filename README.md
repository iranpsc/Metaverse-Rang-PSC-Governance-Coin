...
[![Remix](https://img.shields.io/badge/Remix-Compatible-orange)](https://remix.ethereum.org/)
[![Code Style](https://img.shields.io/badge/Code%20Style-Prettier-ff69b4)](https://prettier.io/)
[![Gas Optimized](https://img.shields.io/badge/Gas-Optimized-success)](https://soliditylang.org/)
...
1. **Day 1** — Airdrop is distributed (tokens are locked in the contract).
2. **Day 1–60** — Recipients cannot withdraw anything (Cliff period).
3. **Day 61** — Vesting begins. Tokens unlock linearly every day.
4. **Day 61–425** — Recipients can claim their vested tokens at any time.
5. **Day 426+** — All tokens are fully claimable.
